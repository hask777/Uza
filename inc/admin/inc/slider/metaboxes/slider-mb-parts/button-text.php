<div class="admin_slider_button_text">
   <div class="admin_slider_button_text_div color">
      <div class="admin_slider_button_text">
         ...
         <input type="text" name="slider_button_text" value="" placeholder="<?php echo __('Текст кнопки', 'uza'); ?>">
      </div>
   </div>
   <div class="admin_slider_button_text_div color">
      <div class="admin_slider_button_text">
         <label for="slider_button_text"><?php echo __('Задать текст кнопки'); ?></label>
         <input type="text" name="color_button" value="" placeholder="<?php echo __('Текст кнопки', 'uza'); ?>">
      </div>
   </div>

   <?php
   echo	$button_collor =  $slider_data['color_button'];
